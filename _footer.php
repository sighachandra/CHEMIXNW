			...
			<div class="info-bar-bottom">
				<div class="container">
					<div class="row">
						<div class="col-lg-3">
							<div class="logo-area">
								<a href="index.php"> <img src="assets/images/logo/logo-white.png" alt="logo"> </a>
							</div>
						</div>
						<div class="col-lg-9">
							<ul class="info-bottom-right">
								...
								<li class="mail-part white">
									...
									<div class="content">
										<h4 class="title">send us mail</h4> <span class="details">
                           <a href="mailto:">contact@chemix-cc.com</a>
                        </span> </div>
								</li>
								<li class="office-time-part white">
									<div class="icon"> <i class="la la-clock"></i> </div>
									<div class="content">
										<h4 class="title">office time</h4> <span class="details">10:00 Am - 06:00 Pm</span> </div>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="col-lg-3">
						<div class="footer-widget widget widget_nav_menu">
							...
							<ul>
								...
								<li> <a href="our-trusted-partners.php"> Trusted Partners</a> </li>
								<li> <a href="projects.php"> Projects</a> </li>
								<li> <a href="area-of-operations.php">Operations</a> </li>
