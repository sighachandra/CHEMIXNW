...
<html lang="en">
  ...
  <body>
   ...
   <?php $page='area-of-operations';?>
    <?php require_once('_header.php');?>
       
    <section class="breadcrumb-area" style="background-image: url('assets/images/service/service-bg.jpg')">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ul>
              ...
              <li class="page-name">Operations</li>
            </ul>
          </div>
        </div>
      </div>
